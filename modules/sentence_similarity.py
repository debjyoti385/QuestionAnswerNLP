...
# Sentence similarity is inspired from the paper "Sentence Similarity Based on Semantic Nets and Corpus Statistics"
# By Yuhua Li, David McLean, Zuhair A. Bandar, James D. OShea, and Keeley Crockett
# Reference and code from blog http://sujitpal.blogspot.com/2014/12/semantic-similarity-for-short-sentences.html
# Modified by Debjyoti Paul for QA system University of Utah
...
def similarityScore(sentence_1, sentence_2, info_content_norm):
    """
...
if __name__ =="__main__":
    sentence_pairs = [
        ...
        ["When they finally retired, the Grads had 108 championships to their credit", "How many games did the Edmonton Grads win?", 0.000],
        [" Of the 522 games they played they won 502!", "How many games did the Edmonton Grads win?", 0.000]
    ]
    for sent_pair in sentence_pairs:
        print "%s\t%s\t%.3f\t%.3f\t%.3f" % (sent_pair[0], sent_pair[1], sent_pair[2],
            similarityScore(sent_pair[0], sent_pair[1], False),
            similarityScore(sent_pair[0], sent_pair[1], True))